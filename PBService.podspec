Pod::Spec.new do |s|
  ...
  s.source_files  = "PBNetService/Pod/PBService/*.{h,m}","PBNetService/Pod/Category/NSURLSessionTask/*.{h,m}"
  s.public_header_files = "PBNetService/Pod/PBService/*.h","PBNetService/Pod/Category/NSURLSessionTask/*.h"
